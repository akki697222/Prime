...
-- Changed by akki697222 for debugging
...
print(_G._CCPC_DEBUGGER_ACTIVE and "Entering debugger." or "Kernel debugging lua prompt.")
...
while running do
    ...
    --    term.setTextColour( colours.yellow )
    --end
    write(_G._CCPC_DEBUGGER_ACTIVE and "lua_debug> " or "kernel> ")
    --term.setTextColour( colours.white )
